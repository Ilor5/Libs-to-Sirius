...
2. Open GY-85 and PWM V2.ioc and press Generate Code (upper right corner);
...
6. Copy next files from cutted folders to Src folder: calculation.c, I2Cdev.c, ITG3205.c, QMC5883L.cpp, and next files to Inc folder: calculation.h, I2Cdev.h, ITG3205.h, QMC5883L.h;
7. In Project.eww Click on Applications (left side), then click on User and right click on it and choose Add - Add Files.
8. Choose, added in step 6, eight files.
