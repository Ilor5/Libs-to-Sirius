...
int GyroCal[4];      /* Буфер для калибровки *********/
...
void getGyroscopeData(int result[]) {
	...
	**************************************/
	...
	result[0] = ((buff[2] << 8) | buff[3]) - g_offx;   /* Скорость вращения по x*/
	result[1] = ((buff[4] << 8) | buff[5]) - g_offy;  /* Скорость вращения по y*/
	result[2] = ((buff[6] << 8) | buff[7]) - g_offz; /* Скорость вращения по z*/
	result[3] = (buff[0] << 8) | buff[1]; /* Температура *********************/
}
/**********************************************/
